...
#### Screenshot 1 — Output of `git init` inside `CodeTrack` showing "Initialized empty Git repository"
   ...
   ![task 1](screenshots/Screenshot%20with%20project%20git%20init.png)

---

#### Screenshot 2 — Output of `ls -a` showing the `.git` folder

![task 1](screenshots/Screenshot%20with%20ls_a_git_folder.png)
...
The .git folder is a folder which is a hidden directory at the root of a project repository that contains all the metadata, configuration, tracking data, and version history for that project.It matters because it acts as the "brain" of your Git repository; without it, your project becomes a collection of regular, untracked files with no historical record.
...
![task 2](screenshots/Screenshot%20with%20git_local_list_3.png)
...
![task 3](screenshots/Screenshot%20with%20git_config_local.png)
